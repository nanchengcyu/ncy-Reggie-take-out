...
[https://www.bilibili.com/video/BV13a411q753/](https://www.bilibili.com/video/BV13a411q753/?spm_id_from=333.337.search-card.all.click&vd_source=f0376b0d81e8dafb55834fe0ef0bbd3a)<br />**瑞吉外卖和苍穹外卖区别**<br />对于苍穹外卖，前端代码部分都是导入的，没有进行编写开发。都是对于接口的分析以及服务端代码的开发<br />苍穹外卖作为瑞吉的增强版，在他原有的基础上新增了SpringTask任务定时（对于待接单和待支付的功能做定时处理），JWT替换Session来实现登录验证，阿里云OSS（实现对象存储，即菜品和套餐图片存储【需要另外学具体的知识】），POI（实现Excel报表的下载），HttpClient（实现微信支付时的信息发送），WebSocket（实现来单提醒和用户催单），<br />PageHelper（做分页处理）<br />![](https://cdn.nlark.com/yuque/0/2024/png/38420467/1705290492488-7bfc4dd3-b494-4fd8-87a8-ee7d9022522d.png#averageHue=%23ecc57c&clientId=ub20e0d13-0f09-4&from=paste&id=u4cd8635d&originHeight=416&originWidth=1097&originalType=url&ratio=1.125&rotation=0&showTitle=false&status=done&style=none&taskId=ud3a9efe3-10f7-4ed6-b288-c5ac855d460&title=)<br />原文链接：[https://blog.csdn.net/AN_NI_112/article/details/132005401](https://blog.csdn.net/AN_NI_112/article/details/132005401)
...
需求分析-》设计-》编码-》测试-》运维<br />![image.png](https://cdn.nlark.com/yuque/0/2024/png/38420467/1705290004039-0a8a9411-ba1a-4a0e-b474-11531a49d272.png#averageHue=%23fbf9fb&clientId=ub20e0d13-0f09-4&from=paste&height=684&id=u17e3394a&originHeight=770&originWidth=1254&originalType=binary&ratio=1.125&rotation=0&showTitle=false&size=182927&status=done&style=none&taskId=udc48e5b0-2e6a-405f-944b-d241e16d91f&title=&width=1114.6666666666667)<br />![image.png](https://cdn.nlark.com/yuque/0/2024/png/38420467/1705290105922-9fc78a30-d154-4dc0-9e21-b7f7ce228bb3.png#averageHue=%23f0edf0&clientId=ub20e0d13-0f09-4&from=paste&height=555&id=u5d097683&originHeight=624&originWidth=1584&originalType=binary&ratio=1.125&rotation=0&showTitle=false&size=406339&status=done&style=none&taskId=u0028764d-9de3-4f86-baa1-6bb06183074&title=&width=1408)<br />![image.png](https://cdn.nlark.com/yuque/0/2024/png/38420467/1705290298364-f2d8ea58-ce4f-4bab-9af8-8055a29cc877.png#averageHue=%23f3f1f3&clientId=ub20e0d13-0f09-4&from=paste&height=710&id=uc1f7c968&originHeight=799&originWidth=1444&originalType=binary&ratio=1.125&rotation=0&showTitle=false&size=450971&status=done&style=none&taskId=u5722284d-98c8-4314-a051-4a941c78cf7&title=&width=1283.5555555555557)
<a name="CDlbI"></a>

#### 项目介绍

![image.png](https://cdn.nlark.com/yuque/0/2024/png/38420467/1705290399122-127299c3-d196-473d-b5ca-bdb230825fc7.png#averageHue=%23f4f2f4&clientId=ub20e0d13-0f09-4&from=paste&height=635&id=u2d5422d8&originHeight=714&originWidth=1674&originalType=binary&ratio=1.125&rotation=0&showTitle=false&size=314530&status=done&style=none&taskId=u10d56b21-40a0-4082-9dea-9decdf4e17f&title=&width=1488)
<a name="gnbeq"></a>

#### 产品原型

一般以html页面展示<br />![image.png](https://cdn.nlark.com/yuque/0/2024/png/38420467/1705290732054-fee5b971-bf43-417b-b27f-729fcea332d0.png#averageHue=%23f8f6f8&clientId=ub20e0d13-0f09-4&from=paste&height=761&id=u905bf6d8&originHeight=856&originWidth=1805&originalType=binary&ratio=1.125&rotation=0&showTitle=false&size=267467&status=done&style=none&taskId=uf76c0b78-b5b5-4bcc-8c27-91836844698&title=&width=1604.4444444444443)
<a name="n21C5"></a>

#### 技术选型

![image.png](https://cdn.nlark.com/yuque/0/2024/png/38420467/1705290755091-79eff2cc-ba5f-41c2-ac14-191d6ec979c7.png#averageHue=%23fbf8fc&clientId=ub20e0d13-0f09-4&from=paste&height=620&id=u36323c29&originHeight=697&originWidth=1726&originalType=binary&ratio=1.125&rotation=0&showTitle=false&size=236156&status=done&style=none&taskId=u934f0f24-0c54-41e6-a5cb-1663ef107de&title=&width=1534.2222222222222)
<a name="wyePm"></a>

#### 功能架构

![image.png](https://cdn.nlark.com/yuque/0/2024/png/38420467/1705290856868-132af6e8-5064-4a20-a9bd-28a300528146.png#averageHue=%239cd1e0&clientId=ub20e0d13-0f09-4&from=paste&height=552&id=ub19274a5&originHeight=621&originWidth=1231&originalType=binary&ratio=1.125&rotation=0&showTitle=false&size=255627&status=done&style=none&taskId=u74870e54-1232-4a7c-b88a-2c73d6918e6&title=&width=1094.2222222222222)
